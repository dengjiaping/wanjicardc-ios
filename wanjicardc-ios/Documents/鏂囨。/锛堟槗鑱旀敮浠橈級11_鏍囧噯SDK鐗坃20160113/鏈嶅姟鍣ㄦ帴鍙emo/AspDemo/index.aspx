...
<body>
    ...
    <form id="form1" action="Order.aspx" method="post" target="_blank">
    <div>
		<table>
    ...
    <form id="form3" action="OrderH5.aspx" method="post" target="_blank">
    <div>
		<table>
            <tr><td colspan='2'>----------------------------------------------------------------</td></tr>
			<tr>
			...
			<tr>
				<td><input type="submit" value="模拟H5页面下单" /></td>
			</tr>
		</table>
    </div>
    </form>
    ...
    <a id='notify' href="Notify.aspx" onclick="return onSubmit();"  target="_blank">模拟订单结果通知</a>

    <form id="form2" action="demoTest.aspx" method="post"  target="_blank">
    <div>
    <table>
        <tr><td colspan='2'>----------------------------------------------------------------</td></tr>
			<tr>
