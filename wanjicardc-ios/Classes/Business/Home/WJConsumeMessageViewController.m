//
//  WJConsumeMessageViewController.m
//  WanJiCard
//
...
@interface WJConsumeMessageViewController ()<APIManagerCallBackDelegate,UITableViewDelegate,UITableViewDataSource>{
...
@implementation WJConsumeMessageViewController
...
{
    WJConsumeMessageTableViewCell * cell = [tableView dequeueReusableCellWithIdentifier:@"WJConsumeMessageTableViewCell"];
    if (nil == cell) {
        cell = [[WJConsumeMessageTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"WJConsumeMessageTableViewCell"];
        cell.selectionStyle = UITableViewCellSelectionStyleNone;
    }
    WJConsumeNewsModel *model = [self.newsListArray objectAtIndex:indexPath.row];
    [cell configData:model cellType:1];
    return cell;
}
