//
//  WJSteamedChargeOrderController.m
//  WanJiCard
//
...
@interface WJSteamedChargeOrderController ()<WJRefreshTableViewDelegate, UITableViewDataSource, UITableViewDelegate>
{
...
@end
@implementation WJSteamedChargeOrderController
- (void)viewDidLoad
{
    [super viewDidLoad];
...
- (APIOrdersManager *)ordersManager{
    if (!_ordersManager) {
        ...
        _ordersManager.orderType = OrderTypeBaoZiCharge;
