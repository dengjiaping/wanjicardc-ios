...
@interface WJWaitingOrderController ()<WJRefreshTableViewDelegate, UITableViewDataSource, UITableViewDelegate>{
...
//    cell.paymentRightNow = ^{
//        [weakSelf.delegate performSelector:@selector(requestLoadOrderPayWith:) withObject:weakSelf.orderArray[indexPath.row]];
//        
//    };
    cell.isOrder = YES;
...
- (APIOrdersManager *)ordersManager{
    if (!_ordersManager) {
        ...
        _ordersManager.orderStatus = OrderStatusUnfinished;
