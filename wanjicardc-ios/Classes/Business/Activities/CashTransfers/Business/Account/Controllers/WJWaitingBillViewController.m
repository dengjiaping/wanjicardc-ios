...
@interface WJWaitingBillViewController ()<WJRefreshTableViewDelegate, UITableViewDataSource, UITableViewDelegate>
{
...
@implementation WJWaitingBillViewController
...
- (APIBillsManager *)billsManager{
    if (!_billsManager) {
        ...
        _billsManager.billStatus = BillStatusUnfinished;
