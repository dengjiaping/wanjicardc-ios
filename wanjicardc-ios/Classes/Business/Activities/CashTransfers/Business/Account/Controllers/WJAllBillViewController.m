...
@interface WJAllBillViewController ()<WJRefreshTableViewDelegate, UITableViewDataSource, UITableViewDelegate>
{
...
@implementation WJAllBillViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [cell configDataWithModel:self.billArray[indexPath.section]];
    return cell;
}
...
- (APIBillsManager *)billsManager{
    if (!_billsManager) {
        ...
        _billsManager.billStatus = BillStatusStatusAll;
