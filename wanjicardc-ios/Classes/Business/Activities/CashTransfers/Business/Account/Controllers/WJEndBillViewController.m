...
@interface WJEndBillViewController ()<WJRefreshTableViewDelegate, UITableViewDataSource, UITableViewDelegate>
{
...
@implementation WJEndBillViewController
...
- (APIBillsManager *)billsManager{
    if (!_billsManager) {
        ...
        _billsManager.billStatus = BillStatusClose;
