//
//  APICardRechargeListersManager.m
//  WanJiCard
//
...
@implementation APICardRechargeListersManager
...
{
    return (self.merchantAccountId.length > 0);
}
...
{
    return @{@"merchantAccountId":self.merchantAccountId};
}

#pragma mark - APIManager Methods
- (NSString *)methodName
{
    return @"/merchantCard/cardRechargeListers";
}
