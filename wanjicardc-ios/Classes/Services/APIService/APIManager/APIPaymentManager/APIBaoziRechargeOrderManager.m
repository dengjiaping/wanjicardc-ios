//
//  APIBaoziRechargeOrderManager.m
//  WanJiCard
//
...
@implementation APIBaoziRechargeOrderManager
- (instancetype)init
{
    self = [super init];
    if (self) {
...
{
    return self.rechargeMoneyID.length > 0;
}
...
- (NSDictionary *)paramsForApi:(APIBaseManager *)manager
{
    ...
    NSMutableDictionary * dic = [NSMutableDictionary dictionaryWithObjectsAndKeys:
                                 self.rechargeMoneyID?:@"", @"rechargeMoneyId",
