...
@implementation APIChargeTotalManager
...
- (NSDictionary *)paramsForApi:(APIBaseManager *)manager
{
    ...
    NSDictionary * dic = @{@"branchMerchId":self.merID,
             @"orderType":type,
             @"merchantCardId":self.merchantCardId,
             @"isLimitForSale":self.isLimitForSale,
