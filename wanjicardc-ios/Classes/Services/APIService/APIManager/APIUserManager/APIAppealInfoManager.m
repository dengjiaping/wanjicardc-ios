...
@implementation APIAppealInfoManager
...
{
    return self.name != nil && self.identityNumber != nil;
}
...
- (NSDictionary *)paramsForApi:(APIBaseManager *)manager
{
    ...
    self.month = [NSString stringWithFormat:@"%2d",month];
        
    return @{@"name":self.name,
             @"idno":self.identityNumber,
             @"rTime":[NSString stringWithFormat:@"%@-%@",
