//
//  APIRealNameVerificationCodeManager.m
//  WanJiCard
//
...
@implementation APIRealNameVerificationCodeManager
...
{
    return self.realName.length > 0 && self.cardNum.length > 0 && self.bankCardNum.length > 0 && self.phoneNum.length > 0;
...
- (NSDictionary *)paramsForApi:(APIBaseManager *)manager
{
    return @{@"custName" :self.realName,
             @"idCode" :self.cardNum,
             @"acctId" :self.bankCardNum,
             @"mobilePhone" :self.phoneNum
             };
}
