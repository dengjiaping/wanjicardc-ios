...
@implementation APIVerifyQuestionManager
...
//    NSString * questionsString = [self.questionsArray componentsJoinedByString:@","];
//    NSString * ansersString = [self.answersArray componentsJoinedByString:@","];
    
    self.question1 = [self.questionsArray objectAtIndex:0];
    self.question2 = [self.questionsArray objectAtIndex:1];
    self.answer1 = [self.answersArray objectAtIndex:0];
    self.answer2 = [self.answersArray objectAtIndex:1];
    
//    return @{@"uqids":questionsString,@"answers":ansersString};
...
//    return @"/security/verify";
    return @"/userSecurityQuestions/validateUsers";
}
