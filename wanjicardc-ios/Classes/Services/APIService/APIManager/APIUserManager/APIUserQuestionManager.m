...
@implementation APIUserQuestionManager
...
{
    return @{@"size":[NSString stringWithFormat:@"%ld",(long)self.questionCount],
             @"phone":self.phone?:@""
             };
}
...
- (NSString *)methodName
{
    return @"/userSecurityQuestions/list";
}
