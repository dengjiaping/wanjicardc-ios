...
@implementation APIUserInfoVerifyManager
...
{
    return self.phone != nil && self.payPassword != nil;
}
...
{
    return @{@"phone":self.phone, @"payPassword":self.payPassword};
}

#pragma mark - APIManager Methods
- (NSString *)methodName
{
    return @"/user/validatePhoneAndPassword";
}
