...
#import "WJVerifyRealNameManager.h"

@implementation WJVerifyRealNameManager
...
{
    return self.realName.length > 0 && self.cardNumber.length > 0 && self.BankCard.length > 0 && self.reservePhone.length > 0;
...
{
    return @{@"custName":self.realName,
             @"idCode":self.cardNumber,
             @"acctId":self.BankCard,
