...
@interface APICardPackageManager()
{
...
@implementation APICardPackageManager
...
- (NSDictionary *)paramsForApi:(APIBaseManager *)manager
{
    ...
    NSDictionary * dic =     [NSDictionary dictionaryWithObjectsAndKeys:
                             [NSString stringWithFormat:@"%ld",(long)self.pageCount],@"pageSize",
                             [NSString stringWithFormat:@"%ld", (long)position],@"pageNum",
                             nil];
