...
@implementation APISetCardNumberManager
...
{
    return self.messageCode.length > 0;
...
{
    return @{@"messageCode":self.messageCode ? : @""};
}

#pragma mark - APIManager Methods
- (NSString *)methodName
{
      return @"/pingan/verifyMessage";
}
