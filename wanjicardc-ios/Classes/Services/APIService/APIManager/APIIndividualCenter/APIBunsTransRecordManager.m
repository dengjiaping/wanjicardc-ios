...
@interface APIBunsTransRecordManager()
{
...
@implementation APIBunsTransRecordManager
...
//        position = _pageNo + 1;
//    }
    return @{@"pageSize":NumberToString(self.pageCount)?:@"20",
             @"pageNum":NumberToString(self.currentPage)};
}

#pragma mark - APIManager Methods
- (NSString *)methodName
{
    return @"/userCenter/myBuns";
}
