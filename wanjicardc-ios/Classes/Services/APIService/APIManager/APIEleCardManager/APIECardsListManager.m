...
@interface APIECardsListManager()
{
...
@implementation APIECardsListManager
...
- (NSDictionary *)paramsForApi:(APIBaseManager *)manager
{
    ...
    return @{@"merchantBranchId":self.merchantBranchId,
             @"pageSize":NumberToString(self.pageCount)?:@"20",
...
- (NSString *)methodName
{
    return @"/thirdCard/selThirdCardList";
}
