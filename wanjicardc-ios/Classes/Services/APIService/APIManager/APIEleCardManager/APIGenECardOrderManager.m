...
@implementation APIGenECardOrderManager
...
- (BOOL)manager:(APIBaseManager *)manager isCorrectWithCallBackData:(NSDictionary *)data
{
    ...
    BOOL isCorrect = [data[@"rspCode"] integerValue] == 0 ;
...
{
    return @{@"purchaseNum":[NSString stringWithFormat:@"%ld",(long)self.buyNumber],
             @"thirdCardId":self.eCardID,
             @"channelId":self.channelId?:@"wjkbun",
...
- (NSString *)methodName
{
    return @"/thirdCard/generateThirdCardOrder";
}
