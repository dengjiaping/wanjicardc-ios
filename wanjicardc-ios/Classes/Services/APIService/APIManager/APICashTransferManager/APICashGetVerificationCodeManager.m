//
//  APICashGetVerificationCodeManager.m
//  WanJiCard
//
...
@implementation APICashGetVerificationCodeManager
...
{
    return @{@"userPhone":self.phoneNum};
}

#pragma mark - APIManager Methods
- (NSString *)methodName
{
    return @"/userWithdraw/getVerificationCode";
