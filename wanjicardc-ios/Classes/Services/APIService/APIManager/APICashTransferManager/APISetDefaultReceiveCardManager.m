//
//  APISetDefaultReceiveCardManager.m
//  WanJiCard
//
...
@implementation APISetDefaultReceiveCardManager
...
{
    return self.bankCardId.length > 0;
...
{
    return @{@"bankCardId" :self.bankCardId};
}

#pragma mark - APIManager Methods
- (NSString *)methodName
{
    return @"/bankcard/default/set";
}
