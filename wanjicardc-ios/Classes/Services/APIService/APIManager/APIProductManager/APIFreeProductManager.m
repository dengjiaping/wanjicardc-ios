...
#import "APIFreeProductManager.h"

@interface APIFreeProductManager()
{
...
@implementation APIFreeProductManager
...
- (BOOL)manager:(APIBaseManager *)manager isCorrectWithCallBackData:(NSDictionary *)data
{
    ...
    NSDictionary *dic = data[@"val"];
    if ([dic isKindOfClass:[NSDictionary class]]) {
        self.callBackCount = [dic[@"total"] integerValue];
    }
...
- (NSDictionary *)paramsForApi:(APIBaseManager *)manager
{
    ...
    NSDictionary * dic =     [NSDictionary dictionaryWithObjectsAndKeys:
                              [NSString stringWithFormat:@"%ld",(long)self.pageCount],@"size",
                              [NSString stringWithFormat:@"%ld", (long)position],@"page",
                              nil];
