...
#import "APISpecialsManager.h"

@implementation APISpecialsManager
...
{
    return  @{@"type":[NSString stringWithFormat:@"%d",self.type],
              @"available":[NSString stringWithFormat:@"%d",self.available]
              };
}
