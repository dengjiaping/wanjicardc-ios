...
@implementation APIMerchantDetailManager
...
{
    return  @{@"merchantId":self.merID,
              @"merchantLatitude":self.merchantLatitude,
              @"merchantLongitude":self.merchantLongitude,
              };
}
