...
@interface APICardExchangeListManager ()
{
...
@implementation APICardExchangeListManager
...
- (NSDictionary *)paramsForApi:(APIBaseManager *)manager
{
    ...
    return @{@"pageSize":NumberToString(self.pageCount),
             ...
             @"thirdCardName":self.thirdCardName ?:@"",
             @"thirdCardSortId":NumberToString(self.thirdCardSortId)?:@""
             };
}
