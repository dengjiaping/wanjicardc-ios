//
//  APICardExchangeVerifyManager.m
//  WanJiCard
//
...
@implementation APICardExchangeVerifyManager
...
- (NSDictionary *)paramsForApi:(APIBaseManager *)manager
{
    return @{@"cardNum":self.cardNumber?:@"",
             @"cardPassword":self.cardPassword?:@"",
             @"exchangeActivityCardId":NumberToString(self.exchangeActivityCardId)?:@""
             };
}
